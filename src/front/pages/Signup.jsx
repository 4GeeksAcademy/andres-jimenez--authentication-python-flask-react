        ...
        <div className="container">
            <Formik
                ...
                validationSchema={Yup.object({
                    ...
                    password: Yup.string().min(8, "Password must be greater thank eight characters").required("Password is required")
                })}
                onSubmit={async (data) => {
                    ...
                    if (response.status === 201) {
                        ...
                        toast.error(response.response.data.message, { position: "bottom-ceneter" })
                    }
                }}
            >
                            ...
                            <div className="row">
                                <div className="col">
                                    <div className="mb-3">
                                        ...
                                        <Field type="password" className="form-control" name="password" id="password" arial-describedby="password" />
